...
- Spawn the `stridebuilder` worker before any implementation reads, edits, or source-directed follow-up happen. If the builder cannot be spawned, stop and report that the patch flow is blocked.
