...
- If a builder is still active on the same scope, wait for it to finish; only split off a second builder when there is a distinct independent slice of work.
